...
public class DataHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        String tablepengajuan = "CREATE TABLE tabelpengajuan(id_pengajuan INTEGER PRIMARY KEY AUTOINCREMENT, username INTEGER, jurusan TEXT, tanggallahir TEXT, statusapprove TEXT, dibaca TEXT, namakampus TEXT, jenispengajuan TEXT, tanggalpengajuan DATETIME, alamatpengaju TEXT, waktupengajuan TIME, tempatlahir TEXT, namaorangtua TEXT, pekerjaanorangtua TEXT, alamatorangtua TEXT, tanggalapprove TEXT, idadmin INTEGER, dibacauser INTEGER);";
